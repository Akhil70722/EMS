# Generated by Django 5.1.6 on 2025-07-04 04:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('leave_type', models.CharField(choices=[('sick', 'Sick Leave'), ('casual', 'Casual Leave'), ('special', 'Special Leave')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tax', models.DecimalField(decimal_places=2, default=200, max_digits=10)),
                ...
                ('final_salary', models.DecimalField(blank=True, decimal_places=2, max_digits=10)),
